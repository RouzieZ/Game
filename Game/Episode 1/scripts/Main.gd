...
func _build_main_menu() -> void:
	...
	menu_status_label.add_theme_color_override("font_color", Color("#8f9b96"))
...
func _build_game_screen() -> void:
	...
	game_title_label.add_theme_color_override("font_color", Color("#d48a54"))
	game_container.add_child(game_title_label)

	chapter_label = Label.new()
	chapter_label.add_theme_color_override("font_color", Color("#b7b7b7"))
	game_container.add_child(chapter_label)

	title_label = Label.new()
	title_label.add_theme_font_size_override("font_size", 28)
	title_label.add_theme_color_override("font_color", Color("#f0f0f0"))
	...
	save_status_label.add_theme_color_override("font_color", Color("#8f9b96"))
	game_container.add_child(save_status_label)

	result_label = Label.new()
	result_label.autowrap_mode = TextServer.AUTOWRAP_WORD_SMART
	result_label.add_theme_color_override("font_color", Color("#d48a54"))
	...
	body_label.add_theme_color_override("default_color", Color("#dedede"))
	story_scroll.add_child(body_label)
	call_deferred("_sync_story_width")

	status_label = Label.new()
	status_label.autowrap_mode = TextServer.AUTOWRAP_WORD_SMART
	status_label.add_theme_color_override("font_color", Color("#b9c7c0"))
...
func _render_scene(scene: Dictionary) -> void:
	...
	body_label.text = str(scene.get("text", ""))
	call_deferred("_sync_story_width")
